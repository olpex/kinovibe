...
module.exports = async function handler(req, res) {
    ...
    const prompt = `Ти професійний кінокритик. Твоє завдання - підібрати 8-10 РЕАЛЬНИХ ІСНУЮЧИХ фільмів, які найкраще відповідають потребам користувача.
КРИТИЧНО ВАЖЛИВІ ПРАВИЛА (ІНАКШЕ ВІДМОВА):
1. ЗАБОРОНЕНО вигадувати сюжети чи фільми, яких не існує! Якщо не знаєш чи фільм підходить - не пиши його. Опис фільму має бути написаний тобою правдиво (українською).
2. ОБОВ'ЯЗКОВИЙ Рік виходу: ${year}. Фільм обов'язково повинен входити у вказаний діапазон років. Не вгадуй, перевір свій внутрішній фактчек.
3. Жанр: ${genre}.
4. Особисті побажання: "${wishes}". (Фільм має ДІЙСНО відповідати цій темі).
Якщо під ці жорсткі критерії підпадає лише 3 фільми - поверни лише 3. Головне - 100% точність фактів!
