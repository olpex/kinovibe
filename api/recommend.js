...
module.exports = async function handler(req, res) {
    ...
    const prompt = `Підбери 8-10 фільмів, які найкраще відповідають цим критеріям.
ОБОВ'ЯЗКОВИЙ Рік виходу: ${year}. Фільми обов'язково повинні входити у вказаний діапазон дат.
Жанр: ${genre}.
...
'plot' (цікавий опис фільму УКРАЇНСЬКОЮ мовою).
